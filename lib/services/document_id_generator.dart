...
class DocumentIdGenerator {
  ...
  static String generateFromFileName(String fileName) {
    try {
      ...
      // Limit length to prevent Firestore issues
      if (cleanName.length > 50) {
        cleanName = cleanName.substring(0, 50);
      }
      
      final documentId = '${_idPrefix}_$cleanName';
  ...
  static String generateForSync(String filePath, String fileName) {
    try {
      ...
      final documentId = '${_syncPrefix}_${pathHash}_${baseId.replaceFirst('${_idPrefix}_', '')}';
  ...
  static List<String> generatePossibleIds(String fileName, {String? filePath}) {
    ...
    try {
      ...
      debugPrint('🔍 Generated ${possibleIds.length} possible document IDs for $fileName');
  ...
  static bool isStandardFormat(String documentId) {
    return documentId.startsWith(_idPrefix) || documentId.startsWith(_syncPrefix);
  }
