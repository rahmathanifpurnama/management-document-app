...
class FileSelectionBar extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FileSelectionBar> createState() => _FileSelectionBarState();
}

class _FileSelectionBarState extends ConsumerState<FileSelectionBar> {
        ...
        children: [
          ...
          TextButton(
            onPressed: isAllSelected
                ? () =>
                      ref.read(fileSelectionProvider.notifier).clearSelection()
                : () => ref.read(fileSelectionProvider.notifier).selectAll(),
            child: Text(
          ...
          if (hasSelection)
            IconButton(
              onPressed: () => _showBulkOperations(context),
  ...
  void _showBulkOperations(BuildContext context) {
